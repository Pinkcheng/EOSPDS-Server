...
PORTER_CENTER_ACCOUNT=porter_center
PORTER_CENTER_PASSWORD=porter_center

# 查詢任務預設天數
MISSION_SELECT_DAYS=3
# 日期格式
...
PORTER_ID_LENGTH=8
STAFF_ID_LENGTH=8
MISSION_ID_LENGTH=10
MISSION_TYPE_ID_LENGTH=2
MISSION_LABEL_ID_LENGTH=4
MISSION_INSTRUMENT_ID_LENGTH=2
DEPARTMENT_ID_BUDING_LENGTH=1
DEPARTMENT_ID_FLOOR_LENGTH=2
DEPARTMENT_ID_ID_LENGTH=4
```