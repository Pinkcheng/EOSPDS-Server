...
export class ResponseHandler {
  static message(code: Response.RESPONSE_STATUS, data: any = {}) {
    const { USER_SUCCESS, USER_PORTER_TYPE_IS_EMPTY, USER_MOBILE_IS_EMPTY: USER_ACCOUNT_IS_EMPTY, USER_NAME_IS_EMPTY, USER_PASSWORD_IS_EMPTY, USER_REPEAT_NAME, USER_REPEAT_ACCOUNT, USER_REPEAT_PORTER_TAG_NUMBER, USER_UNKNOWN, USER_PORTER_TYPE_NOT_FOUND, AUTH_ACCOUNT_IS_EMPTY, AUTH_ID_IS_EMPTY, AUTH_INVALID_TOKEN, AUTH_LOGIN_FAIL, AUTH_PASSWORD_IS_EMPTY, AUTH_SUCCESS, AUTH_TOKEN_EXPIRED, AUTH_TOKEN_IS_EMPTY, AUTH_ACCESS_FAIL, AUTH_UNKNOWN, DATA_SUCCESS, DATA_DELETE_SUCCESS, DATA_REQUIRED_FIELD_IS_EMPTY, DATA_UNKNOWN, DATA_UPDATE_FAIL, DATA_REPEAT, DATA_UPDATE_SUCCESS, DATA_CREATE_SUCCESS, DATA_CREATE_FAIL, AUTH_ACCESS_DATA_FAIL, MISSION_NOT_DISPATCH, MISSION_ALREADY_FINISH, MISSION_ALREADY_STARTED, MISSION_NOT_STARTED, MISSION_ALREADY_DISPATH } = Response.RESPONSE_STATUS;
    ...
    switch (code) {
      ...
      case MISSION_NOT_STARTED:
        message = '【錯誤：任務】任務尚未開始';
        break;
      case MISSION_ALREADY_DISPATH:
        message = '【錯誤：任務】任務已經指派給傳送員';
        break;
      case MISSION_ALREADY_STARTED:
        message = '【錯誤：任務】任務已經開始';
        break;
      case MISSION_ALREADY_FINISH:
        message = '【錯誤：任務】任務已經完成';
        break;
