...
export class ResponseHandler {
  static message(code: Response.RESPONSE_STATUS, data: any = {}) {
    const { USER_SUCCESS, USER_PORTER_TYPE_IS_EMPTY, USER_ACCOUNT_IS_EMPTY, USER_NAME_IS_EMPTY, USER_PASSWORD_IS_EMPTY, USER_REPEAT_NAME, USER_REPEAT_ACCOUNT, USER_REPEAT_PORTER_TAG_NUMBER, USER_UNKNOWN, USER_PORTER_TYPE_NOT_FOUND, AUTH_ACCOUNT_IS_EMPTY, AUTH_ID_IS_EMPTY, AUTH_INVALID_TOKEN, AUTH_LOGIN_FAIL, AUTH_PASSWORD_IS_EMPTY, AUTH_SUCCESS, AUTH_TOKEN_EXPIRED, AUTH_TOKEN_IS_EMPTY, AUTH_ACCESS_FAIL, AUTH_UNKNOWN, DATA_SUCCESS, DATA_DELETE_SUCCESS, DATA_REQUIRED_FIELD_IS_EMPTY, DATA_UNKNOWN, DATA_UPDATE_FAIL, DATA_REPEAT, DATA_UPDATE_SUCCESS, DATA_CREATE_SUCCESS } = Response.RESPONSE_STATUS;
